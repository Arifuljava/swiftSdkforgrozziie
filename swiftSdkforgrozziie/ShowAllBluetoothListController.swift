//
//  ShowAllBluetoothListController.swift
//  swiftSdkforgrozziie
//
...
class ShowAllBluetoothListController: UIViewController,  CBCentralManagerDelegate, CBPeripheralDelegate, UITableViewDelegate, UITableViewDataSource{
